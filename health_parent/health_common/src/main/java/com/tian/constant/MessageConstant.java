...
public class MessageConstant {
    ...
    public static final String QUERY_CHECKITEMIDSBYCHECKGROUPID_SUCCESS = "查询检查组包含检查项成功";
    public static final String QUERY_CHECKITEMIDSBYCHECKGROUPID_FAIL = "查询检查组包含检查项失败";
